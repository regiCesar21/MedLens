...
REDUCED_DIR = os.path.join(DATA_DIR, "reduced30StratNew")  # Diretório para os arquivos reduzidos
...
def stratified_sample_in_chunks(file_path, sample_size, stratify_col, chunk_size=10**5):
    ...
    # Flag para controlar se o arquivo final precisa de headers
    need_headers = True
    ...
    sample_df.to_csv(partial_file_path, index=False, header=need_headers)
